...
import useIntersectionObserver from '../hooks/useIntersectionObserver'; // Optional for animations
  ...
  return (
    <div className="bg-bgCanvas">
      ...
      <div className="py-16 md:py-24 bg-primary text-white text-center">
        <div className="container mx-auto px-4 animate-on-scroll fade-in-up is-visible"> {/* Assume always visible or add observer */}
