...
const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // For demo, password can be optional, or add more checks
          ...
          <div className="rounded-md shadow-sm">
            ...
            <div className="-mt-px">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-3 border border-borderStrong placeholder-textSubtle text-textBase focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm"
            ...
            <div className="-mt-px">
              ...
              <input
                ...
                type="password"
                autoComplete="new-password"
                // required (if password is required)
