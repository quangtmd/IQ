...
export type StaffRole = 'Sales Manager' | 'Content Editor' | 'Technical Lead' | 'Support Specialist' | 'Full Access Staff';
export const STAFF_ROLE_OPTIONS: StaffRole[] = ['Sales Manager', 'Content Editor', 'Technical Lead', 'Support Specialist', 'Full Access Staff'];
