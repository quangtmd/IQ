...
import { NAVIGATION_LINKS_BASE, SITE_CONFIG_STORAGE_KEY, INITIAL_SITE_SETTINGS } from '../../constants';
...
const Footer: React.FC = () => {
  ...
  const socialLinksData = [
    ...
    { name: 'Zalo', iconClass: "fas fa-comment-dots", url: settings.socialZaloUrl }, // Zalo icon might need adjustment
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {NAVIGATION_LINKS_BASE.slice(0, 6).map(link => (
                 <li key={link.path}>
