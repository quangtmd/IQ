...
export const BACKEND_API_BASE_URL = "http://localhost:3001"; // Thay thế bằng URL API backend thực tế của bạn
...
export const ADMIN_EMAIL = "quangtmdit@gmail.com"; // Giữ nguyên email quản trị
...
const INITIAL_HOMEPAGE_BANNER: HomepageBannerSettings = {
  ...
  imageAltText: "Giải Pháp và Dịch Vụ IT - Văn Phòng Hiện Đại với Công Nghệ",
...
const INITIAL_HOMEPAGE_FEATURED_PROJECTS: HomepageFeaturedProjectsSettings = {
  ...
  buttonLink: "/services",
  featuredServiceIds: ['1','2','3','4'], // ID dịch vụ mẫu
};
...
const INITIAL_HOMEPAGE_BLOG_PREVIEW: HomepageBlogPreviewSettings = {
  ...
  featuredArticleId: 'it005', // ID bài viết nổi bật mẫu
  otherArticleIds: ['it001', 'it002'], // ID các bài viết khác mẫu
};
...
export const INITIAL_SITE_SETTINGS: SiteSettings = {
  ...
  companyEmail: "quangtmdit@gmail.com", // Giữ nguyên email
...
export const PC_BUILDER_PATH = '/pc-builder'; // Giữ nguyên đường dẫn
...
export const NAVIGATION_LINKS_BASE: Omit<CustomMenuLink, 'order' | 'isVisible' | 'originalPath' | 'id'>[] = [
  ...
  { label: 'Xây dựng PC', path: PC_BUILDER_PATH, icon: 'fas fa-tools'}, // Label cho PC Builder
...
export const MOCK_PRICING_PLANS_DATA: PricingPlan[] = [
  ...
  { id: 'plan2', name: 'Gói Chuyên Nghiệp', price: 'Liên hệ', period: 'Mỗi Tháng', features: ['Hỗ trợ ưu tiên 24/7 (SLA)', 'Bảo trì định kỳ toàn diện (Tháng/lần)', 'Sao lưu dữ liệu đám mây (cơ bản)', 'Quản lý bảo mật Endpoint'], isPopular: true, buttonText: 'Yêu cầu báo giá', buttonLink: '/contact' },
